#!/bin/bash
#SBATCH -o /work/bm1164/m300832/ContinentalSetup/Forward/Logs/SLURM_job.%j.%N.out
#SBATCH -e /work/bm1164/m300832/ContinentalSetup/Forward/Logs/SLURM_job.%j.%N.err
#SBATCH -D /work/bm1164/m300832/ContinentalSetup/Forward/
#SBATCH -J Forward
#SBATCH --get-user-env
